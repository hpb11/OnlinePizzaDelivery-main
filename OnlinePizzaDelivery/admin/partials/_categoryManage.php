...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(isset($_POST['createCategory'])) {
        ...
        if($result) {
            ...
            if($check !== false) {
                ...
                if (copy($_FILES['image']['tmp_name'], "file:///C:/xampp/htdocs/OnlinePizzaDelivery-main/OnlinePizzaDelivery/img/card-" . $catId . ".jpg") && move_uploaded_file($_FILES['image']['tmp_name'], "file:///C:/xampp/htdocs/OnlinePizzaDelivery-main/OnlinePizzaDelivery/admin/assetsForSideBar/img/card-" . $catId . ".jpg")) {
    ...
    if(isset($_POST['removeCategory'])) {
        $catId = $_POST["catId"];
        $filename = $_SERVER['DOCUMENT_ROOT']."assetsForSideBar/img/card-".$catId.".jpg";
        ...
        if ($result){
            ...
            echo "<script>alert('Removed Category Successfully');
                window.location=document.referrer;
                </script>";
        }
        else {
