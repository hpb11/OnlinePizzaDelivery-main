              ...
              <div class="card card-shadow border-0 mb-4">
                <div class="row">
                  ...
                  <?php
                    ...
                    echo '<div class="col-lg-4" style=" background-color: green;">
                          <div class="detail-box p-4">
                            <h5 class="text-white font-weight-light mb-3">ADDRESS</h5>
                            <p class="text-white op-7">' ."Nirma University, Ahmedabad". '</p>
                            <h5 class="text-white font-weight-light mb-3 mt-4">CALL US</h5>
                            <p class="text-white op-7">' ."+91 8160317658". '
                              <br> ' ."+91 7383825258". '</p>
                            <div class="round-social light">
                              <a href="https://mail.google.com/mail/divycholera98@gmail.com' .$email. '" class="ml-0 text-decoration-none text-white border border-white rounded-circle" target="_blank"><i class="far fa-envelope"></i></a>
                              <a href="https://github.com/divycholera98" class="text-decoration-none text-white border border-white rounded-circle" target="_blank"><i class="fab fa-github"></i></i></a>
