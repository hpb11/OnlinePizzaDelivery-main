<?php
    ...
    if(isset($_POST["updateProfilePic"])){
        ...
        if($check !== false) {
            ...
            // C:\xampp\htdocs\OnlinePizzaDelivery-main\OnlinePizzaDelivery
            $uploaddir ='C:/xampp/htdocs/OnlinePizzaDelivery-main/OnlinePizzaDelivery/OnlinePizzaDelivery/img/';
