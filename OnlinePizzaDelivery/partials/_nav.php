...
echo '<nav class="navbar navbar-expand-lg navbar-dark bg-teal">
      <a class="navbar-brand" href="index.php" style="font-family:Brush Script MT, Brush Script Std, cursive; color: green;  font-size: 25px;">A slice of Heaven</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent" >
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <a class="nav-link" href="index.php" style="color: green;">Home <span class="sr-only">(current)</span></a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link" href="viewOrder.php" style="color: green;">Your Orders</a>
          </li>
      
          <li class="nav-item">
            <a class="nav-link" href="contact.php" style="color: green;">Contact Us</a>
          </li>
        ...
        if($loggedin){
          echo '<ul class="navbar-nav mr-2">
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" style="color:green";> Welcome ' .$username. '</a>
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
